...
$search = $_GET['search'] ?? 'не удалось передать значение';
$search = trim($search);
...
<body id="dialog">
    ...
    <div class="content">
        <h2>Результаты поиска для: "<?= htmlspecialchars($search) ?>"</h2>
        <div class="catalog">
            ...
            <?php foreach ($products as $product): ?>
                <div class="card">
                    <?php if (!empty($product['img'])): ?>
                        <img src="<?= htmlspecialchars($product['img']) ?>" alt="Фото товара">
                    <?php endif; ?>
                    ...
                    <div class="incard">
                        ...
                        <dl class="attributes"><dt>Категория:</dt> <dd><?= htmlspecialchars($product['category']) ?></dd></dl>
