...
<head>
    ...
    <title>Шпильки/Шайбы/Гайки</title>
...
<body>
    ...
    <div class="content">
        <div class="catalog">
            <?php if (isset($products['Шпильки/Шайбы/Гайки'])): ?>
                <?php foreach ($products['Шпильки/Шайбы/Гайки'] as $product): ?>
                    <div class="card">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Нет товаров в категории "Шпильки/Шайбы/Гайки".</p>
            <?php endif; ?>
        </div>
    </div>
    <footer>
