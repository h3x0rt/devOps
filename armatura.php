...
// Получаем ID категории "Арматура"
...
// Получаем атрибуты для всех товаров
$attributesData = [];
if (!empty($productIds)) {
...
<body>
    ...
    <nav>
        <div class="content nav-content">
            ...
            <a href="armatura.php"><div class="nav-button nav-active">Арматура</div></a>
    ...
    <div class="content ">
        <div class="catalog">
            <?php if (isset($products[$categoryName]) && count($products[$categoryName]) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Нет товаров в категории "Арматура".</p>
            <?php endif; ?>
