...
<head>
    ...
    <title>Горячекатаные листы</title>
...
<body>
    ...
    <div class="content">
        <div class="catalog">
            <?php if (isset($products['Горячекатанный лист'])): ?>
                <?php foreach ($products['Горячекатанный лист'] as $product): ?>
                    <div class="card">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Нет товаров в категории "Горячекатанный лист".</p>
            <?php endif; ?>
        </div>
    </div>
    <footer>
