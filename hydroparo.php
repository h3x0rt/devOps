...
<head>
    ...
    <title>Гидроизоляция и Пароизоляция</title>
...
<body>
    ...
    <div class="content">
        <div class="catalog">
            <?php if (isset($products['Гидроизоляция/Пароизоляция'])): ?>
                <?php foreach ($products['Гидроизоляция/Пароизоляция'] as $product): ?>
                    <div class="card">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Нет товаров в категории "Гидроизоляция/Пароизоляция".</p>
            <?php endif; ?>
        </div>
    </div>
    <footer>
