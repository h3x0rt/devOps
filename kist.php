...
<body>
    ...
    <div class="content">
        <div class="catalog">
            <?php if (isset($products['Кисточки/Валики'])): ?>
                <?php foreach ($products['Кисточки/Валики'] as $product): ?>
                    <div class="card">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Нет товаров в категории "Кисточки/Валики".</p>
            <?php endif; ?>
        </div>
    </div>
    <footer>
